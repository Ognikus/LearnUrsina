...
class Game(Ursina):
    ...
    def __init__(self):
        ...
        Entity(model='quad', scale=60, textures="gray_cub", texture_scale=(60, 60), rotation_x=90, y=-10,
               color=color.light_gray)  # Цвет пола
        Entity(model='sphere', scale=100, texture='textures/sky1', double_sided=True)  # Небо
        EditorCamera()
        camera.world_position = (0, 0, -55)
